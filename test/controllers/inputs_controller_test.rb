...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post inputs_url, params: { input: { level: @input.level, question: @input.question, task_id: @input.task_id } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { level: @input.level, question: @input.question, task_id: @input.task_id } }
